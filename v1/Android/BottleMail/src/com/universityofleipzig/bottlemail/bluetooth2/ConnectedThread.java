...
public class ConnectedThread extends Thread {
	...
	public ConnectedThread(BluetoothSocket socket,
			GenericListener<MSGEvent> listener) {
		mmSocket = socket;
...
//				try {
//					mGenericListener.notify(new MessageEvent(this,new BMail(-1, "Buffer: " + new String(buffer) + " , " + byteToHex(buffer)+"|bytes"+bytes,"Debug", Calendar.getInstance(),false)));
//				} catch (JSONException e1) {
//					Log.e(TAG, "CT-run: JSONException: " + e1.getMessage());
//				}
			} catch (IOException e) {
